...
# ---------------------- MAIN APP ----------------------
    ...
    # --- Dashboard Page ---
        ...
        st.subheader("🌐 Dashboard Overview") 
        st.markdown(""" 
        The dashboard provides an interactive view of **global economic and financial metrics**, including income inequality, GDP trends, and other key financial indicators. It allows you to explore patterns, compare countries, and analyze trends over time. 
        """) 

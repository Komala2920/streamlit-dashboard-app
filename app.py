...
# ---------------------- MAIN APP ----------------------
    ...
    if st.session_state.page == "🏠 Home":
        ...
        # --- Lottie Animation ---
        st_lottie_url("https://assets2.lottiefiles.com/packages/lf20_usmfx6bp.json", height=200)
    ...
    # --- Dashboard Page ---
        ...
        st_lottie_url("https://lottiefiles.com/free-animation/analytics-character-animation-rSQ1Cjs8wv.json", height=200)
    ...
    # --- Profile Page ---
        ...
        st.header("👤 Edit Profile")
         # --- Lottie Animation ---
        st_lottie_url("https://assets1.lottiefiles.com/packages/lf20_rr7upw7o.json", height=200)
    ...
    # --- Feedback Page ---
        ...
        st.header("💬 Feedback")
        st_lottie_url("https://assets5.lottiefiles.com/packages/lf20_cvx0pqrz.json", height=200)

...
# ---------------------- MAIN APP ----------------------
   ...
   # --------Sidebar Navigation ---------
    ...
    if st.session_state.page == "🏠 Home":
        ...
        st_lottie_url("https://assets10.lottiefiles.com/packages/lf20_aUnT5PRo2P.json", height=200)
   ...
   # ---------------------- Chatbot Page ----------------------
        ...
        # Lottie Animation: Man and Robot
        st_lottie_url("https://assets10.lottiefiles.com/packages/lf20_QnbODCGAFt.json", height=200)

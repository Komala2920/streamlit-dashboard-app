...
# ---------------------- MAIN APP ----------------------
    ...
    if st.session_state.page == "🏠 Home":
        ...
        # --- Lottie Animation ---
        st_lottie_url("https://assets7.lottiefiles.com/packages/lf20_kdx6cani.json", height=200)
    ...
    # --- Profile Page ---
        ...
        st.header("👤 Edit Profile")
         # --- Lottie Animation ---
        st_lottie_url("https://assets1.lottiefiles.com/packages/lf20_u4yrau.json", height=200)
    ...
    # --- Feedback Page ---
        ...
        st.header("💬 Feedback")
        st_lottie_url("https://assets8.lottiefiles.com/packages/lf20_9rgmlokp.json", height=200)
